...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tourism', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_35022803b0da00e9989770c09d66979a9bb247a99a9052a94f9a3de974000003');
    ...
    /**
     * Gets the 'find_tour' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\FindTour A AppBundle\Services\FindTour instance.
     */
    protected function getFindTourService()
    {
        return $this->services['find_tour'] = new \AppBundle\Services\FindTour($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/.*/delete');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/edit');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/.*/edit');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/member/');
        ...
        $o->add($k, array(0 => 'ROLE_DELETE'), NULL);
        $o->add($l, array(0 => 'ROLE_MEMBER'), NULL);
        $o->add($m, array(0 => 'ROLE_EDIT'), NULL);
        $o->add($n, array(0 => 'ROLE_MEMBER'), NULL);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9b58b724955a8f2a66dc49f19e071fa5d92d6a18');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_ADMIN' => array(0 => 'ROLE_SUPERUSER'), 'ROLE_SUPERUSER' => array(0 => 'ROLE_EDIT', 1 => 'ROLE_DELETE'), 'ROLE_EDIT' => array(0 => 'ROLE_MEMBER'), 'ROLE_MEMBER' => array(0 => 'ROLE_TOUR', 1 => 'ROLE_CITY', 2 => 'ROLE_TOURISTATTRACTION', 3 => 'ROLE_HOTEL', 4 => 'ROLE_COUNTRY', 5 => 'ROLE_USER')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '9b58b724955a8f2a66dc49f19e071fa5d92d6a18',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '9b58b724955a8f2a66dc49f19e071fa5d92d6a18',
