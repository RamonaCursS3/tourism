...
var $addTagLink = $('<a href="#" class="btn btn-default add_tag_link">Add images</a>');

var $newLinkLi = $('<li class="image"></li>').append($addTagLink);
...
$(document).ready(function(){
    ...
    $collectionHolder.find('li:not(.image)').each(function() {
